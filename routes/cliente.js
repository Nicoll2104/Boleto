...
router.post("/agregar",[
    ...
    check('nombre', 'El nombre es obligatorio y debe tener al menos 5 caracteres').isLength({ min: 5 }),
    check('apellido', 'El apellido es obligatorio y debe tener al menos 8 caracteres').isLength({ min: 8 }),
